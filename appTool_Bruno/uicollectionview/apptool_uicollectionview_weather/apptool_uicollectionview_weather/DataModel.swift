...
extension DataModel {
    ...
    DataModel(number: 1, weatherName: "맑음", weatherIcon: "sun.min"),
    DataModel(number: 2, weatherName: "더움", weatherIcon: "sun.max.fill"),
    DataModel(number: 3, weatherName: "일출", weatherIcon: "sunrise"),
    DataModel(number: 4, weatherName: "일몰", weatherIcon: "sunset"),
    DataModel(number: 5, weatherName: "맑음&먼지", weatherIcon: "sun.dust"),
    DataModel(number: 6, weatherName: "맑음&바람", weatherIcon: "sun.haze"),
    DataModel(number: 7, weatherName: "구름", weatherIcon: "cloud"),
    DataModel(number: 8, weatherName: "바람", weatherIcon: "wind"),
    DataModel(number: 9, weatherName: "눈", weatherIcon: "snow"),
    ]
}
